  ...
  return (
    <Main>
      ...
      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-zinc-900 mb-6">📚 Documentação Completa</h2>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          >
            <h3 className="text-lg font-semibold text-blue-900 mb-2">📖 Portal de Docs</h3>
          ...
          <Link
            ...
            className="rounded-2xl bg-blue-50 p-6 shadow-sm ring-1 ring-blue-200/60 hover:ring-blue-300/80 transition-all hover:bg-blue-100"
          >
            <h3 className="text-lg font-semibold text-blue-900 mb-2">📊 Sumário Executivo</h3>
            <p className="text-sm text-blue-700">
          ...
          <Link
            ...
            className="rounded-2xl bg-blue-50 p-6 shadow-sm ring-1 ring-blue-200/60 hover:ring-blue-300/80 transition-all hover:bg-blue-100"
          >
            <h3 className="text-lg font-semibold text-blue-900 mb-2">🏗️ Arquitetura</h3>
            <p className="text-sm text-blue-700">
          ...
          <Link
            ...
            className="rounded-2xl bg-blue-50 p-6 shadow-sm ring-1 ring-blue-200/60 hover:ring-blue-300/80 transition-all hover:bg-blue-100"
          >
            <h3 className="text-lg font-semibold text-blue-900 mb-2">📋 Escopo MVP</h3>
            <p className="text-sm text-blue-700">
          ...
          <Link
            ...
            className="rounded-2xl bg-blue-50 p-6 shadow-sm ring-1 ring-blue-200/60 hover:ring-blue-300/80 transition-all hover:bg-blue-100"
          >
            <h3 className="text-lg font-semibold text-blue-900 mb-2">♿ Acessibilidade</h3>
            <p className="text-sm text-blue-700">
          ...
          <Link
            ...
            className="rounded-2xl bg-blue-50 p-6 shadow-sm ring-1 ring-blue-200/60 hover:ring-blue-300/80 transition-all hover:bg-blue-100"
          >
            <h3 className="text-lg font-semibold text-blue-900 mb-2">📄 Relatório Técnico</h3>
            <p className="text-sm text-blue-700">
      ...
      <section className="rounded-2xl bg-zinc-50 p-6 mb-12">
        <h3 className="text-lg font-semibold text-zinc-900 mb-3">♿ Acessibilidade</h3>
      ...
      {/* Equipe */}
      <section className="mb-12">
        <h2 className="text-2xl font-semibold text-zinc-900 mb-6">👥 Equipe</h2>
        <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-zinc-200/60">
